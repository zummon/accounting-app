...
<div class="px-2 pb-4">
	...
	<abbr class="no-underline" title={$query.date.start}>
		<label class="mb-2 mr-2">
			...
			<input class="border-0 px-2 py-0.5 bg-transparent" type="datetime-local" bind:value={$query.date.start} />
		</label>
	</abbr>
	<br />
	<abbr class="no-underline" title={$query.date.end}>
		<label class="mb-2 mr-2">
			...
			<input class="border-0 px-2 py-0.5 bg-transparent" type="datetime-local" bind:value={$query.date.end} />
		</label>
	</abbr>
	<br />
